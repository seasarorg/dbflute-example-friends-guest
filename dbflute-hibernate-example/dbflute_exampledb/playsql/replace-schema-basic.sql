...
(
	MEMBER_WITHDRAWAL_ID INTEGER NOT NULL PRIMARY KEY,
	MEMBER_ID INTEGER NOT NULL,
...
(
	MEMBER_SECURITY_ID INTEGER NOT NULL PRIMARY KEY,
	MEMBER_ID INTEGER NOT NULL,
...
ALTER TABLE MEMBER_SECURITY ADD CONSTRAINT UQ_MEMBER_SECURITY UNIQUE (MEMBER_ID) ;
ALTER TABLE MEMBER_WITHDRAWAL ADD CONSTRAINT UQ_MEMBER_WITHDRAWAL UNIQUE (MEMBER_ID) ;
