 ...
 */
@MappedSuperclass
public abstract class BsPurchaseSummaryMember implements Serializable {
    ...
    /**
     * PURCHASE_SUMMARY: {BIGINT(10)} <br />
     */
    public Long purchaseSummary;
    ...
    public String toString() {
        ...
        sb.append(delimiter).append(purchaseSummary);
